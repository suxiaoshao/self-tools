...
impl From<String> for OtherNameValue {
	fn from(value: String) -> Self {
		OtherNameValue::Utf8String(value)
	}
}

impl From<&str> for OtherNameValue {
	fn from(value: &str) -> Self {
		OtherNameValue::Utf8String(value.to_owned())
	}
}
...
impl From<String> for DnValue {
	fn from(value: String) -> Self {
		DnValue::Utf8String(value)
	}
}

impl From<&str> for DnValue {
	fn from(value: &str) -> Self {
		DnValue::Utf8String(value.to_owned())
	}
}
