...
| `S-18` | i18n                                                            | User-visible copy, error/validation text, labels, accessibility text, interpolation, plural/select, or formatting                            | Key owner, all supported locales, variables, caller/UI state, fallback                                    |
