...
use service::{
    author::Author, collection::Collection, novel::Novel, novel_comment::NovelComment,
    save_draft::*,
};
...
fn draft(id: &str) -> SaveDraftNovel {
    SaveDraftNovel {
        id: id.into(),
        site: model::schema::custom_type::NovelSite::Jjwxc,
        name: "novel".into(),
        description: "private".into(),
        image: "".into(),
        novel_status: model::schema::custom_type::NovelStatus::Ongoing,
